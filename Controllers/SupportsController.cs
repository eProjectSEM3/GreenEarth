...
using GreenEarth.Models;

namespace GreenEarth.Controllers
{
    public class SupportsController : Controller
    {
        private GreenEarthEntities db = new GreenEarthEntities();
        ...
        public ActionResult Create([Bind(Include = "SupportId,Description")] Support support)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SupportId,Description")] Support support)
        {
            if (ModelState.IsValid)
            {
